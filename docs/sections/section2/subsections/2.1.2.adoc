...
| Seller | Attribute/Role | Domain | A User who posts a clothing item on the platform to make it visible for reuse or resale.
| Buyer | Attribute/Role | Domain | A User who browses listings and contacts sellers to express interest in an item.
...
| bookmarkListing(Listing, Buyer) -> ListingBookmarked | Event Function | Design | Function that triggers the event when a Buyer bookmarks a Listing, making it appear in the Saved Listings page.
