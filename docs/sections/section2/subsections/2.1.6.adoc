...
Postconditions:: `InterestExpressed` is recorded linking Buyer, Seller, and Listing.
...
Postconditions:: `ReviewSubmitted` is attached to the parties.
...
Description:: Marks a Piece as inactive and removes it from circulation.
