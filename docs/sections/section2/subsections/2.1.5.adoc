...
*Interest Expressed*::  
An instantaneous occurrence when a buyer contacts a seller indicating they want more information or wish to acquire the item.
